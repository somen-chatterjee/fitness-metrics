import 'package:fitness_metrics/ui/athlete/settings_evaluation/components/progress_photo_card.dart';
...
class _ProgressPhotoState extends State<ProgressPhoto> {
  late ProgressPhotoController evalCtrl;
  ...
  void initState() {
    super.initState();
    Get.delete<ProgressPhotoController>();
    evalCtrl = Get.put(ProgressPhotoController());
            ...
            children: [
              InkWell(
                ...
                onTap: () async{
                  ...
                  Get.to(() => UploadProgressPhoto(athleteId: userId));
                },
                child: Row(
                  children: [
                    SvgPicture.asset(
