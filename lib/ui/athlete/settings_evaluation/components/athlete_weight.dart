...
class _WeightState extends State<Weight> {
  late WorkoutEditController workoutEditCtrl;

  @override
  void initState() {
    super.initState();
    workoutEditCtrl = Get.find<WorkoutEditController>();
    workoutEditCtrl.selectedMonth.value = 'All';
    workoutEditCtrl.athleteDetailsChart();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
              ...
              Container(
                ...
                child: PopupMenuButton<String>(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      BaseText(
                        value: workoutEditCtrl.selectedMonth.value,
                        fontSize: 12,
                        fontWeight: FontWeight.w400,
                      ),
                      const Icon(
                  ...
                  onSelected: (v) {
                    // setState(() {
                    // print('!!!===== $v');
                    workoutEditCtrl.selectedMonth.value = v;
                    workoutEditCtrl.athleteDetailsChart();
                    // });
                  },
                ),
        ...
        GetBuilder<WorkoutEditController>(
              ...
              children: [
                Obx(() {
                  return GestureDetector(
                    onTap: () => workoutEditCtrl.zoomPanBehavior.zoomOut(),
                    child: workoutEditCtrl.isZoomedOut.value
                ...
                Obx(() {
                  return GestureDetector(
                    onTap: () => workoutEditCtrl.zoomPanBehavior.zoomIn(),
                    child: workoutEditCtrl.isZoomedIn.value
