...
import 'package:fitness_metrics/ui/athlete/settings_evaluation/components/athlete_measurement.dart';
import 'package:fitness_metrics/ui/athlete/settings_evaluation/components/athlete_progress_photo.dart';
import 'package:fitness_metrics/ui/athlete/settings_evaluation/components/athlete_weight.dart';
...
class _BodyCompositionState extends State<BodyComposition> {
  var evaluationCtrl = Get.find<EvaluationController>();

  @override
  void initState() {
    super.initState();
    evaluationCtrl.compositionType.value = 'Weight';
    Get.put(WorkoutEditController());
  }
              ...
              return Container(
                ...
                child: PopupMenuButton<String>(
                  ...
                  onSelected: (v) {
                    ...
                    // evaluationCtrl.callCompositionData();
                  },
                ),
              );
            }),
