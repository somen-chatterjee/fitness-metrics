...
import 'package:fitness_metrics/ui/coach/clients_athletes/models/coach_group_model.dart';
...
class AllGroupController extends GetxController {
  ...
  void getGroupList({required int page}) async {
    ...
    // log("$mapData");
    BaseApiService()
        .post(apiEndPoint: ApiEndPoints().groupList, data: mapData, showLoader: page == 1)
        .then((value) async {
      if (value?.statusCode == 200) {
        try {
          CoachGroupModel response = CoachGroupModel.fromJson(value?.data);
