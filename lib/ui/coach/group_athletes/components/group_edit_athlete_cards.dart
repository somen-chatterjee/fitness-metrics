...
class GroupEditAthleteCards extends StatefulWidget {
  final Athlete athleteData;

  const GroupEditAthleteCards({super.key, required this.athleteData});

  @override
  State<GroupEditAthleteCards> createState() => _GroupEditAthleteCardsState();
}

class _GroupEditAthleteCardsState extends State<GroupEditAthleteCards> {
  final createGroupCtrl = Get.find<EditGroupController>();
