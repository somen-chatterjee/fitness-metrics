...
import 'package:fitness_metrics/ui/coach/task_edit/controller/task_edit_controller.dart';
...
class _TaskEditState extends State<TaskEdit> {
  var taskAddCtrl = Get.put(TaskEditController());

  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      taskAddCtrl.editTask(taskId: widget.taskId);
    });
  }
              ...
              child: Form(
                ...
                child: BaseColumn(
                  children: [
                    ...
                    //date time
                    GetBuilder<TaskEditController>(builder: (logic) {
                      return Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Expanded(
                                  ...
                                  suffixIcon: Padding(
                                    ...
                                    child: SvgPicture.asset(
                                      ...
                                      colorFilter: const ColorFilter.mode(
                                          BaseColors.grey, BlendMode.srcIn),
                                    ),
                                  ),
                                  validator: (val) {
                    ...
                    BaseButton(
                      ...
                      onPressed: () {
                        if (taskAddCtrl.taskFormKey.currentState!.validate()) {
                          taskAddCtrl.taskUpdate(taskId: widget.taskId);
                        }
                      },
                    ),
                    buildSizeHeight(35),
